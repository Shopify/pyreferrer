...
def test_email_simple():
  ...
  expected_referrer = {
    ...
    'label': 'Gmail',
    'raw_url': 'https://mail.google.com/9aifaufasodf8usafd',
...
def test_social_simple():
  ...
  expected_referrer = {
    ...
    'label': 'Twitter',
    'raw_url': 'https://twitter.com/snormore/status/391149968360103936',
...
def test_social_with_prefix_www():
  ...
  expected_referrer = {
    ...
    'raw_url': 'https://www.twitter.com/snormore/status/391149968360103936',
    'domain': 'twitter.com',
  }
  assert_equals(expected_referrer, referrer)
...
def test_social_with_prefix_m():
  ...
  expected_referrer = {
    ...
    'raw_url': 'https://m.twitter.com/snormore/status/391149968360103936',
    'domain': 'twitter.com',
  }
  assert_equals(expected_referrer, referrer)
...
def test_social_with_prefix_l():
  ...
  expected_referrer = {
    ...
    'raw_url': 'https://l.twitter.com/snormore/status/391149968360103936',
    'domain': 'twitter.com',
  }
  assert_equals(expected_referrer, referrer)
...
def test_social_with_prefix_lm():
  ...
  expected_referrer = {
    ...
    'raw_url': 'https://lm.twitter.com/snormore/status/391149968360103936',
    'domain': 'twitter.com',
  }
  assert_equals(expected_referrer, referrer)
...
def test_social_google_plus():
  ...
  expected_referrer = {
    'type': Referrer.Types.SOCIAL,
    'label': 'Google+',
    'url': 'http://plus.url.google.com/url',
    'raw_url': 'http://plus.url.google.com/url?sa=z&n=1394219098538&url=http%3A%2F%2Fjoe.blogspot.ca&usg=jo2tEVIcI5Wh-6t--v-1ODEeGG8.',
...
def test_search_simple():
  ...
  expected_referrer = {
    ...
    'raw_url': 'http://search.yahoo.com/search?p=hello',
...
def test_search_with_query_in_fragment():
  ...
  expected_referrer = {
    'type': Referrer.Types.SEARCH,
    'label': 'Yahoo!',
    'raw_url': 'http://search.yahoo.com/search',
...
def test_search_with_fuzzy_yahoo_country():
  ...
  expected_referrer = {
    'type': Referrer.Types.SEARCH,
    'label': 'Yahoo!',
    'url': 'http://ca.search.yahoo.com/search',
    'raw_url': 'http://ca.search.yahoo.com/search?p=hello',
...
def test_search_bing_not_live():
  ...
  expected_referrer = {
    ...
    'label': 'Bing',
    'url': 'http://bing.com/',
    'raw_url': 'http://bing.com/?q=blargh',
    'domain': 'bing.com',
    'query': 'blargh',
  }
  assert_equals(expected_referrer, referrer)
...
def test_search_non_ascii():
  ...
  expected_referrer = {
    ...
    'label': 'Yahoo!',
    'url': 'http://search.yahoo.com/search',
    'raw_url': 'http://search.yahoo.com/search;_ylt=A0geu8fBeW5SqVEAZ2vrFAx.;_ylc=-?p=vinduespudsning+myshopify+rengøring+mkobetic&fr2=sb-top&fr=yfp-t-715&rd=r1',
    'domain': 'search.yahoo.com',
...
def test_search_with_cryllics():
  ...
  expected_referrer = {
    'type': Referrer.Types.SEARCH,
    'label': 'Yandex',
    'url': 'http://www.yandex.com/yandsearch',
    'raw_url': 'http://www.yandex.com/yandsearch?text=%D0%B1%D0%BE%D1%82%D0%B8%D0%BD%D0%BA%D0%B8%20packer-shoes&lr=87&msid=22868.18811.1382712652.60127&noreask=1',
...
def test_search_with_explicit_plus():
  ...
  expected_referrer = {
    ...
    'label': 'Yahoo!',
    'url': 'http://search.yahoo.com/search',
    'raw_url': 'http://search.yahoo.com/search;_ylt=A0geu8nVvm5StDIAIxHrFAx.;_ylc=-?p=vinduespudsning+JOKAPOLAR+"11+%2B+11"+mkobetic&fr2=sb-top&fr=yfp-t-715&rd=r1',
    'domain': 'search.yahoo.com',
...
def test_search_with_empty_query():
  ...
  expected_referrer = {
    ...
    'label': 'Yahoo!',
    'url': 'https://yahoo.com',
    'raw_url': 'https://yahoo.com?p=&sa=t&rct=j&p=&esrc=s&source=web&cd=1&ved=0CDkQFjAA&url=http%3A%2F%2Fwww.yellowfashion.in%2F&ei=aZCPUtXmLcGQrQepkIHACA&usg=AFQjCNE-R5-7CENi9oqYe4vG-0g0E7nCSQ&bvm=bv.56988011,d.bmk',
    'domain': 'yahoo.com',
    'query': '',
  }
  assert_equals(expected_referrer, referrer)
...
def test_search_google_with_query():
  ...
  expected_referrer = {
    ...
    'raw_url': 'https://www.google.co.in/url?sa=t&rct=j&q=test&esrc=s&source=web&cd=1&ved=0CDkQFjAA&url=http%3A%2F%2Fwww.yellowfashion.in%2F&ei=aZCPUtXmLcGQrQepkIHACA&usg=AFQjCNE-R5-7CENi9oqYe4vG-0g0E7nCSQ&bvm=bv.56988011,d.bmk',
